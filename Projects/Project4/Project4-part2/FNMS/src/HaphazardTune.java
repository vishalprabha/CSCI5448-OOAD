    ...
    public boolean tune(Item itemObj){
        if(Objects.equals(itemObj.getClass().getSuperclass().getName(), "Players")){
            ...
            if(OuterUtils.Utils.getRandomProbability(50)){
                ...
                System.out.println("The item "+itemObj.getClass().getName()+"'s equalized property changed from "+!playerObj.equalized+ " to "+ playerObj.equalized+ " during haphazard tuning");
            ...
            if(OuterUtils.Utils.getRandomProbability(50)){
                ...
                System.out.println("The item "+itemObj.getClass().getName()+"'s tuned property changed from "+!stringObj.tuned+ " to "+ stringObj.tuned+ " during haphazard tuning");
                // Return true if equalized value changed from true to false
            ...
            if(OuterUtils.Utils.getRandomProbability(50)){
                ...
                System.out.println("The item "+itemObj.getClass().getName()+"'s adjusted property changed from "+!windObj.adjusted+ " to "+ windObj.adjusted+ " during haphazard tuning");
                // Return true if equalized value changed from true to false
