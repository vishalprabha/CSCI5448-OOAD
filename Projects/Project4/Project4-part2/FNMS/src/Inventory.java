...
public class Inventory {
    ...
    Inventory(){
        ...
        for (int index = 0; index < 3; index ++){
            ...
            purchasePrice = OuterUtils.Utils.getRandomPrice(1,50);
            PlayersCD playersCD = new PlayersCD(OuterUtils.Utils.getRandomName(), purchasePrice, purchasePrice*2, "New", 0, "excellent", false);
            ItemsList.add(playersCD);
            purchasePrice = OuterUtils.Utils.getRandomPrice(1,50);
            RecordPlayer recordPlayer = new RecordPlayer(OuterUtils.Utils.getRandomName(), purchasePrice, purchasePrice*2, "New", 0, "excellent", false);
            ...
            purchasePrice = OuterUtils.Utils.getRandomPrice(1,50);
            Bass bass = new Bass(OuterUtils.Utils.getRandomName(), purchasePrice, purchasePrice*2, "New", 0, "excellent", OuterUtils.Utils.getRandomBoolean(), false);
            ItemsList.add(bass);
            purchasePrice = OuterUtils.Utils.getRandomPrice(1,50);
            Mandolin mandolin = new Mandolin(OuterUtils.Utils.getRandomName(), purchasePrice, purchasePrice*2, "New", 0, "excellent", OuterUtils.Utils.getRandomBoolean(), false);
            ItemsList.add(mandolin);
            purchasePrice = OuterUtils.Utils.getRandomPrice(1,50);
            Flute flute = new Flute(OuterUtils.Utils.getRandomName(), purchasePrice, purchasePrice*2, "New", 0, "excellent", OuterUtils.Utils.getRandomName(), false);
            ItemsList.add(flute);
            purchasePrice = OuterUtils.Utils.getRandomPrice(1,50);
            Harmonica harmonica = new Harmonica(OuterUtils.Utils.getRandomName(), purchasePrice, purchasePrice*2, "New", 0, "excellent", OuterUtils.Utils.getRandomName(), false);
